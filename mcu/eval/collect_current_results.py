...
Usage:
    python collect_current_results.py --board stm32-nucleo-h7s3l8
"""
import argparse
...
def main():
    ...
    board_list = ['stm32-nucleo-h7s3l8', 'esp32', 'arduino-nano-rp2040-connect-mbed', 'arduino-nano-rp2040-connect-pico']
    ...
    out_dir = PROJECT_ROOT / "mcu" / "eval" / "online" / args.board / 'pec'
    out_dir.mkdir(parents=True, exist_ok=True)
    out_path = out_dir / "current_results.csv"
