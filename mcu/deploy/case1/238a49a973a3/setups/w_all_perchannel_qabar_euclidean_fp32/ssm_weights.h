...
#define SSM_A_BAR_BAKED(w, r, c) ((float)(w)->A_bar_q[(r) * SSM_D_STATE + (c)] * (w)->A_bar_scale[(r)])
#define SSM_B_BAR_BAKED(w, r, c) ((float)(w)->B_bar_q[(r) * SSM_D_STATE + (c)] * (w)->B_bar_scale[(r)])
