...
/* CLASSIC (selective=False) backbone, quantized-float schemes: w_all_*
 * with qab or qabar, pertensor or perchannel, with or without
 * actboundaries. Identical in shape to the selective ssm_backbone.h --
 * the recurrence differs, the state does not. */
