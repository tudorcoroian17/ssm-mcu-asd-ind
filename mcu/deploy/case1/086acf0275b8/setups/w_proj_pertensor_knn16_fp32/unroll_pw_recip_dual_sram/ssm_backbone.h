...
/* QUANTIZED-FLOAT backbone (selective): w_proj_* and w_all_* setups,
 * pertensor or perchannel, with or without actboundaries. Weights are
 * int8 + scale, dequantized inline by the SSM_*_W macros in the generated
 * ssm_weights.h. The arithmetic is float. */
