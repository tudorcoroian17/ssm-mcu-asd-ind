...
#define SSM_X_PROJ_W(w, r, c) ((float)(w)->x_proj_w_q[(r) * SSM_D_INNER + (c)] * (w)->x_proj_w_scale[0])
#define SSM_DT_PROJ_W(w, r, c) ((float)(w)->dt_proj_w_q[(r) * SSM_DT_RANK + (c)] * (w)->dt_proj_w_scale[0])
